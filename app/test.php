...
<div class="container">
  ...
  print "foo_string\n";
  var_dump($foo_string);
  print 'Type: ' . gettype($foo_string) . "\n";
  print 'Int Val: ' . (int) $foo_string . "\n";
  print 'String Val: ' . (string) $foo_string . "\n";
  print "\n";

  $foo_int_string = 'bar123';
  print "foo_int_string\n";
  //$foo_int_string = 2;
  var_dump($foo_int_string);
  print 'Type: ' . gettype($foo_int_string) . "\n";
  print 'Int Val: ' . (int) $foo_int_string . "\n";
  print 'String Val: ' . (string) $foo_int_string . "\n";
  print "\n";
